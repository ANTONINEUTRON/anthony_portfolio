...
const VertTabs = ()=>{
    ...
    return (
        <ul className="hidden md:flex flex-col space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
            {/* <li>
            ...
            <li>
                <Link href={{ pathname: "/", hash: "about"}} className={`${viContext!!.stringValue.includes("about") && "bg-primary"} inline-flex items-center hover:bg-primary px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 w-full`}>
            ...
            <li>
                <Link href={{ pathname: "/", hash: "education"}} className={`${viContext!!.stringValue.includes("education") && "bg-primary"} inline-flex items-center hover:bg-primary px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 w-full`}>
                    <Book className="w-4 h-4 me-2 text-gray-500 dark:text-gray-400"/> 
                    Education
                </Link>
            </li>
            <li>
                <Link href={{ pathname: "/", hash: "skills"}} className={`${viContext!!.stringValue.includes("skills") && "bg-primary"} inline-flex items-center hover:bg-primary px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 w-full`}>
            ...
            <li>
                <Link href={{ pathname: "/", hash: "experience"}} className={`${viContext!!.stringValue.includes("experience") && "bg-primary"} inline-flex items-center hover:bg-primary active:bg-primary px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 w-full`}>
